...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-primary-200/20 dark:border-primary-800/20 bg-background/90 backdrop-blur-xl">
            ...
            <Link href="/" className="-m-1.5 p-1.5 group">
              ...
              <div className="flex items-center space-x-3">
                <div className="relative">
                  <div className="w-10 h-10 bg-gradient-infinex rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform duration-200">
                    <Calculator className="w-6 h-6 text-white" />
                  </div>
                  <div className="absolute -top-1 -right-1 w-3 h-3 bg-accent-500 rounded-full animate-pulse" />
                </div>
                <div className="hidden sm:block">
                  <span className="text-xl font-bold bg-gradient-infinex bg-clip-text text-transparent">
                    AmplifyROI
                  </span>
                  <Badge variant="secondary" className="ml-2 text-xs bg-primary-100 text-primary-700 dark:bg-primary-900 dark:text-primary-300">
                    Pro
                  </Badge>
                </div>
              </div>
